...
class Trainer:
    ...
    def trainBatch(self, thisBatchIndices):
        ...
        # Compute loss
#         yTrain = yTrain.type(torch.long)        
#         print(yHatTrain)
#         print(yTrain)

        lossValueTrain = self.model.loss(yHatTrain, yTrain.type(torch.long))
...
#             print(yHatValid)
#             print(yValid)
            lossValueValid = self.model.loss(yHatValid, yValid.type(torch.long))
